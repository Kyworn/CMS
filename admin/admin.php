  ...
  <body>
    ...
    if(isset($_SESSION['status']))  {
      if($_SESSION['status']  == 'Administrateur'){
        ...
        echo('<div id="text"><div id="postNumber"><i class="material-icons" style="font-size:6em;">
<a href="article.change.php">insert_chart</a></i><p>Nombre d&apos;article : ');
        echo count($rResultPosts);


        echo('</p></div><br> <div id="postComment"><i class="material-icons" style="font-size:6em;">
<a href="comment.change.php">comment</a></i><p>Nombre de commentaire : ');
        echo count($rReseultComment);


        echo('</p></div><br> <div id="postUsers"><i class="material-icons" style="font-size:6em;">
<a href="user.change.php">person_pin</a></i><p>Nombre d&apos;utilisateur : ');
